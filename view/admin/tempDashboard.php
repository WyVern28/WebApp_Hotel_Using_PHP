...
<body>
    ...
    <div class="main-content">
        ...
        <div class="stats-container">
            <a href="../../controller/admin/adminKasir.php">
                <div class="stat-box stat-blue">Total Kasir: <?php echo count($data['allKasir']); ?></div>
            </a>
            <a href="../../controller/admin/adminTamu.php">
                <div class="stat-box stat-yellow">Total Tamu: <?php echo count($data['allTamu']); ?></div>
            </a>
            <a href="../../controller/admin/adminKamar.php">
                <div class="stat-box stat-green">Total Kamar: <?php echo count($data['allKamar']); ?></div>
            </a>
