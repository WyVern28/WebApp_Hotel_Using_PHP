            ...
            <div class="struk">
                ...
                <div class="section">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">Rp <?php echo number_format($booking['harga_per_malam'], 0, ',', '.'); ?></span>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">Rp <?php echo number_format($booking['jumlah_bayar'] ?? $booking['total_harga'], 0, ',', '.'); ?></span>
                    </div>
                    <div class="info-row">
