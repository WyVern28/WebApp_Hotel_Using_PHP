    ...
    <div class="booking-wrapper">
        <div class="booking-form">
            <div class="date-group">
                ...
                <input type="date" name="checkin" class="date-input" id="checkinFilter"
            ...
            <div class="date-group">
                ...
                <input type="date" name="checkout" class="date-input" id="checkoutFilter"
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-bottom">
                                    <div class="price-info">
                                        <span class="price">Rp
                                            <?php echo number_format($room['harga_per_malam'], 0, ',', '.'); ?></span>
